...
global err numTiles numPixels generateButton output_folder_path InputFileName InputPathName InputFilterIndex input_folder_path
...
%break if any errors
if err == 1;
 % clear err generateButton input_folder_path InputFileName InputFilterIndex InputPathName numPixels numTiles output_folder_path source_imgs_dir_path target_imgs_dir_path
  close all; 
